...
// TODO/DONE: Uncomment the following line of code to see the output in the browser console
...
// Another way that could be considered more readable would be:
// let objectLit = array => ({
//     key1: 'value1',
//     key2: 'value2',
//     key3: 'value3'
...
//Maybe the code below could be used to make a specific "Joe" object?
// let joe = array => ({ name: 'Joe', age: 100, hometown: 'Schmoe'})

// TODO/DONE: Uncomment the following line of code to see the output in the browser console
// Note that the arrow function will cause this code to break!
console.log(joe);

// TODO/DONE: After viewing the previous console.log(), return the code to a working state.
...
//  The console.log on line 209 returned the "Joe" instance of the Student object. Line 213 returned as undefined 
// 2. What is "this" when joe.scopeArrow() is invoked?
//  The console.log on line 215 returned the "Window" object.  Line 218 returned as undefined
// 3. Explain why "this" is different when an arrow function is used.
// If I understand it correctly, arrow functions don't have a "this" that is unique to them and so in this case the "this" returned a global, or parent i.e. the "Window".